...
<div class="row flex-lg-row-reverse align-items-center g-5 py-5">
  <div class="col-10 col-sm-8 col-lg-6">
    <img src="assets/uploads/img-acceuil.jpg" class="d-block mx-lg-auto img-fluid" alt="Logo voiture" width="350" loading="lazy">
  </div>
  <div class="col-lg-6">
...
<div class="row">
  <div class="col-md-4">
    <div class="card">
      <img src="assets/uploads/pic-3-home.jpg" class="card-img-top" alt="...">
      <div class="card-body">
  ...
  <div class="col-md-4">
    <div class="card">
      <img src="assets/uploads/pic-2-home.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
        <a href="#" class="btn btn-primary">Go somewhere</a>
